...
(def cvdata
  {:basic {:name "Johnny Brown" :email "hire@thejohnnybrown.com"
   ...
   :experience [{:position "Bioinformatics Programmer"
                ...
                {:position "Software Developer"
                 ...
                 :description
                 (str
                   "I used many of different technologies here, building custom"
